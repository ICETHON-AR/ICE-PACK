...
async def _(event):  # كتابة الملف بواسطه  : @ICE50
    if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
        await event.edit("قـريبا خـاص بـسورس آيس ثون")
